...
subject to
{
  forall(t in t0..tf-1)
  {
    ...
    {  
		...
		acc[i][t] - sum(e in edge: e.i==i)demandFlow[e][t] <= 10000 * (1-y[i][t]);
		phi[i][t] <= 10000*y[i][t];
		...
		sum(e in edge: e.i==i && e.i!=e.j) (rebFlow[<e.j, e.i>][t] - rebFlow[<e.i, e.j>][t]) - desiredAcc[i][t] + acc[i][t]  - sum(e in edge: e.i==i)demandFlow[e][t]<= 10000 * u[i][t];
		acc[i][t] - sum(e in edge: e.i==i)rebFlow[e][t]  - sum(e in edge: e.i==i)demandFlow[e][t] <= 10000 * v[i][t];
		rho[i][t] <= 10000 * (1-u[i][t]);
		pi[i][t] <= 10000 * (1-v[i][t]);
      	if(t == t0)
      		acc[i][t] == accInit[i];
 	}  	    
    forall(e in edge)
    {
		...
		demandFlow[e][t] <= 10000*z[e][t];
		alpha[e][t] <= 10000*(1-x[e][t]);
		gamma[e][t] <= 10000*(1-z[e][t]);  
		tt[e] - rho[e.j][t] + rho[e.i][t] + pi[e.i][t] - xi[e][t] == 0;
		rebFlow[e][t] <= 10000 * (1-w[e][t]);
		xi[e][t] <= 10000 * w[e][t];
	}
  }
